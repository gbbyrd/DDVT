""" This script was used to collect instance segmentation/semantic segmentation 
data to see if this could improve the generation of smaller objects of interest
such as traffic lights, traffic signs, poles, etc."""
